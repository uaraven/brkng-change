    ...
    implements DiffPrinter
{
  ...
  private static final Map<DiffType, String> MESSAGES = ImmutableMap.<DiffType, String>builder()
      ...
      .put(DiffType.ClassDeprecated, ansi().a("Class [").fg(MBR).a("${object.apiName}").fgDefault().a("]")
      ...
      .put(DiffType.MethodRemoved,
          ansi().a("Method [").fg(MBR).a("${object.apiName}").fgDefault().a("] has been removed")
              .fgDefault().toString())
      ...
      .put(DiffType.MethodAnnotationsChanged, ansi().a("Method [").fg(MBR).a("${object.apiName}").fgDefault().a(
          ...
          .fgBright(HL).a("${changed.from}").fgDefault().a("] to [").fgBright(HL).a("${changed.to}")
          .fgDefault().a("]").toString())
      .put(DiffType.MethodDeprecated, ansi().a("Method [").fg(MBR).a("${object.apiName}").fgDefault().a("]")
          .fgBright(HL).a(" became deprecated").fgDefault().toString())
      .build();
